    ...
    <div class="panel">
        <div class="panel-heading">
            <div class="panel-title">
                {{ isset($categories[$ticket->category_id]) ? $categories[$ticket->category_id] : 'Undefined category' }}@if ($userId == $ticket->responsible_id) from {{ ucfirst($ticket->userCreate->username) }}@endif, <strong>{{ $firstMessage->date_time_create }}</strong>
            </div>
        </div>
        ...
        <div class="panel-footer">
            <div>
                ...
                <strong>
                    Responsible user: {{ ($ticket->responsible_id) ? $ticket->userResponsible->username : 'Not assigned' }}
                </strong>
            </div>
            ...
            <div class="panel-body">
                ...
                @else
                    <div class="message-author">
                        {{ $message->user->username }}, {{ $message->date_time_create }}
                    </div>
                @endif
...
@push('scripts')
    ...
    <script src="/build/js/backend/tickets/tickets.min.js"></script>
