                        ...
                        <li class="user-body">
                            <div class="row">
                                <div class="col-sm-6 text-center">
                                    <a href="#" class="uk-button uk-button-small uk-button-default site-oval-button">Profile</a>
                                </div>
                                <div class="col-sm-6 text-center">
                                    <a href="/account/logout" style="color: white !important;"
                                       class="uk-button uk-button-default uk-button-small red darken-1 site-oval-button">Sign out</a>
                                </div>
                            </div>
                            <!-- /.row -->
                        </li>
