        ...
        <div class="footer-widgets-wrap clearfix">
            ...
            <div class="col_two_fifth">
                ...
                <div class="widget clearfix">
                    ...
                    <div class="d-inline-block p-1 circular ui image bg-white mb-3"
                    ...
                    <p class="ls1 t300" style="opacity: 0.6; font-size: 13px;">Copyrights &copy; {{date('Y')}} {{config('app.name')}}</p>
            ...
            <div class="col_three_fifth col_last">
                ...
                <div class="col_half col_last">
                    ...
                    <div class="widget subscribe-widget subscribe-form clearfix" data-loader="button">
                        ...
                        <form role="form" class="nobottommargin">
                            <input type="email" id="widget-subscribe-form-email"
                                   name="widget-subscribe-form-email"
                                   class="sm-form-control not-dark required email"
                                   placeholder="Enter your Email">
                            <button class="button button-3d button-black noleftmargin norightmargin"
