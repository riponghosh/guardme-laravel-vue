...
@section('app')
    <div class="row bg-title">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h4 class="page-title"><i class="fa fa-users"></i> Employers</h4>
        </div>
        <!-- /.col-lg-12 -->
    </div>
                ...
                <div class="panel-heading users-list">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            ...
                            <div class="row" v-if="selected_filter == 'category'">
                                <div class="col-lg-5 col-md-12 col-sm-12">
                        ...
                        <tbody>
                            <tr v-for="user in users" v-if="user.status != 2">
                                ...
                                <td class="actions text-right">
                                    <button class="btn btn-danger waves-effect waves-light" @click.prevent="suspend(user.id)" title="Suspend"><i class="fa fa-pause"></i></button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
@push('scripts')
    <script>
        var FETCH_USERS_ENDPOINT = '/api/account/profile/users/employers';
    </script>
